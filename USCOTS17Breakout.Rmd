...
- Students
    - 30 students (33 begining of semester)
    - most did have a STAT course of some kind
...
- Learned some new things during the semester
    
### Data Computing Fundamentals (Macalester)  
...
- prevents excessive reliance on interactive commands (they don't work!)
...
## Other things your students can do
...
- basic data wrangling operations: `select()`, `filter()`, `group_by()`, `arrange()`, `mutate()`
- reshape data from wide to narrow using `gather()` for plotting
- `ggplot()` graphics showing monthly win percentages throughout season for each team
- constructed list containing data frame for champions from 1970 to 2012
...
- exploring trends among vegeterian and vegan restaurants
